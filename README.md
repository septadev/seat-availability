...
## Latest release
Latest version: [v202205080](https://github.com/septadev/seat-availability/releases/tag/v202205080), containing estimates for the week of May 8, 2022 to May 14, 2022.
These estimates are based on data collected from April 16 through May 1, 2022 for most bus routes, Regional Rail routes, subway/elevated routes, and the Norristown High Speed Line.
