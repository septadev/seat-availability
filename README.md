...
## Latest release
Latest version: [v202210300](https://github.com/septadev/seat-availability/releases/tag/v202210300), containing estimates for the week of October 30, 2022 to November 5, 2022.
These estimates are based on data collected from October 8 through October 23, 2022 for most bus routes, Regional Rail routes, subway/elevated routes, and the Norristown High Speed Line.
