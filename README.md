...
## Latest release
Latest version: [v202204170](https://github.com/septadev/seat-availability/releases/tag/v202204170), containing estimates for the week of April 17, 2022 to April 23, 2022.
These estimates are based on data collected from March 26 through April 10, 2022 for most bus routes, Regional Rail routes, subway/elevated routes, and the Norristown High Speed Line.

### Changes in this version:
* This version contains improved predictions for some city routes due to improved data availability.
