...
## Latest release
Latest version: [v202209180](https://github.com/septadev/seat-availability/releases/tag/v202209180), containing estimates for the week of September 18, 2022 to September 24, 2022.
These estimates are based on data collected from August 20 through September 4, 2022 for most bus routes, and August 28 through September 11 for Regional Rail routes, subway/elevated routes, and the Norristown High Speed Line.

### Changes in this version:
* This version uses GTFS v202209101, which contains minor changes from the previous version. As a result, some routes may have fewer estimations available.
