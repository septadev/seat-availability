...
## Latest release
Latest version: [v202210231](https://github.com/septadev/seat-availability/releases/tag/v202210231), containing estimates for the week of October 23, 2022 to October 29, 2022.
These estimates are based on data collected from September 24 through October 9, 2022 for most bus routes, Regional Rail routes, subway/elevated routes, and the Norristown High Speed Line.

### Changes in this version:
* This version corrects a data availability issue which caused some Regional Rail estimates to be less accurate than usual.
