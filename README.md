...
## Latest release
Latest version: [v202412070](https://github.com/septadev/seat-availability/releases/tag/v202412070), containing estimates for the week of December 7th, 2024.
These estimates are based on data collected from most bus routes, Regional Rail routes, subway/elevated routes, and the Norristown High Speed Line.
